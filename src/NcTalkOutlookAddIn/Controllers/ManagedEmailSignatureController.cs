...
{
    internal sealed class ManagedEmailSignatureController
    {
        ...
        internal ManagedEmailSignatureController(NextcloudTalkAddIn owner)
        {
            _owner = owner;
        }
            ...
            out string source)
        {
            ...
            try
            {
                ...
                File.WriteAllText(
                    tempHtmlPath,
                    WordHtmlInsertionFile.EnsureHtmlDocumentForWordInsert(content),
            ...
            {
                WordHtmlInsertionFile.TryDeleteTemporaryHtmlFile(tempHtmlPath, "Failed to delete temporary email signature HTML file.");
            }
        }
